...
The day records are the entry points. Existing machine-local artifacts under
`20260915/` are listed below for auditability; the verification reports under
`outputs/local_verification/` remain local and are not part of this log.
...
- `20260915/biological_closure/outputs/complete_chain_trace.json`
- `20260915/biological_closure/outputs/runs/closure-engagement-regression/evaluation_repair_decision.json`
- `20260915/biological_closure/outputs/runs/closure-real-v3-regression/evaluation_rows_decision.json`
- `20260915/biological_closure/outputs/runs/closure-real-v3-regression/score_table_rows_decision.json`
- `20260915/biological_closure/outputs/verified/comparison.json`
- `20260915/biological_closure/outputs/verified/complete_chain_trace.json`
- `20260915/log_curation/outputs/audit.json`
- `20260915/log_curation/outputs/DAILY_REGISTER.json`
- `20260915/log_curation/outputs/documentation_checks.json`
- `20260915/log_curation/outputs/documentation_checks.txt`
- `20260915/log_curation/outputs/LOG_AUDIT.md`
- `20260915/log_curation/outputs/SCI_LOG_OVERVIEW.html`
- `20260925/README.md`
